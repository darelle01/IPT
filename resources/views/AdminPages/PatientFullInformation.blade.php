    ...
    <div class="PatientFullBasicInformation">
        ...
        <div class="PatientNumberandPhilhealthArea">
            <div class="PatientNumberandPhilhealthValue">
                <div class="PatientNumberArea">
                    <label class="PatientNumberValue">{{$patient->PatientID}}</label>
                </div>
                <div class="PhilHealthArea">
        ...
        <div class="ContactAndEmailArea">
            <div class="ContactAndEmailValue">
                <div class="ContactArea">
                    <label class="ConatactValue">{{$patient->ContactNumber}}</label>
                </div>
                <div class="EmailArea">
                    <label class="EmailValue">{{$patient->email}}</label>
                </div> 
            </div>
        </div>{{-- Contact and Email Value --}}
        <div class="ButtonArea">
            <button class="update bg-primary">Update</button>
        </div>
        @endforeach
            ...
            <div class="MedicalLogsInputArea">
                ...
                <div class="MedicalLogInput">
                    ...
                    <div class="ConsultationInputArea">
                        <select name="Consultation" class="ConsultationValue">
                    ...
                    <div class="DateOfConsultationInputArea">
                        <input type="date" name="DateOfConsultation" class="DateOfCheckUpValue">
                    ...
                    <div class="ActionBtnArea">
                        <button class="ActionBtn bg-primary">Save</button>
                    </div>{{-- Action Slot --}}
